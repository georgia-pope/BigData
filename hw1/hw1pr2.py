...
if __name__ == '__main__':
	...
	y_space = []
	"*** YOUR CODE HERE ***"
	X_space = np.linspace(0, 5, num=100, endpoint=True)
	...
	W_opt = None
	"*** YOUR CODE HERE ***"
	X_space_stacked = np.concatenate(([np.ones_like(X_space)], [X_space]), axis=0)  # need to be replaced following hint 1 and 2
